...
Card {
	...
	ChartView {
		...
		BarSeries {
			...
			BarSet { 
				values: Scenario.years[Scenario.currentYearIndex].technical.chargingAndDemand.demand.usersPerHour 
	...
	UsersPerHourChartPlotXAxis {
		id: xAxisTicks
		spacing: (chart.width - (this.elementWidth*23))/37
